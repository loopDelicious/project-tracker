...
COPY grades (student_github, project_title, grade, id) FROM stdin;
jhacks	Markov	10	1
jhacks	Blockly	2	2
...
3	Guessing-Game	For Loops Game	25
4	Shopping-Cart	Bootstrap project	50
5	Madlibs	Flask-Jinja	50
\.
